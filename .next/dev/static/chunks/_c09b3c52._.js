...
"[project]/src/app/dashboard/_components/grafico.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Grafico() {
    ...
    const [time, setTime] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("30 days");
    // Fazer um fetch
    ...
    //Sempre faça o useEffect para não dar looping infinito
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Grafico.useEffect": ()=>{
            fetchWorkout();
        }
    ...
    const filterWorkout = ()=>{
        ...
        return workout.filter((w)=>new Date(w.date) >= daysAgo);
    };
    // Prepara os dados para o gráfico de LINHA (distancia x data)
    const preparaLine = ()=>{
        const filtered = filterWorkout();
        return filtered.sort((a, b)=>new Date(a.date).getDate() - new Date(b.date).getDate()).map((workout)=>({
    ...
    // Prepara os dados para o gráfico de BARRAS( CALORIAS X DATA)
    const preparaBarra = ()=>{
        const filtered = filterWorkout();
        return filtered.sort((a, b)=>new Date(a.date).getDate() - new Date(b.date).getDate()).map((workout)=>({
                date: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(workout.date), "dd/MM", {
    ...
    const preparaPizza = ()=>{
        ...
        return distanceRanges.filter((e)=>e.count > 0);
    };
    // Estatisticas  gerais
    const gerais = ()=>{
        const filtered = filterWorkout();
        ...
        const totalDistance = filtered.reduce((sum, w)=>w.distance + sum, 0);
        const totalCalories = filtered.reduce((sum, w)=>w.calories + sum, 0);
        const totalDuration = filtered.reduce((sum, w)=>w.duration + sum, 0);
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {}, void 0, false, {
                        fileName: "[project]/src/app/dashboard/_components/grafico.tsx",
                        lineNumber: 195,
                        columnNumber: 21
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(Grafico, "jTo4uVVP8pAwJiahXVrXlJ4UCPA=");
_c = Grafico;
var _c;
__turbopack_context__.k.register(_c, "Grafico");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_c09b3c52._.js.map